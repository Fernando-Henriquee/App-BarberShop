...
import { cancelBooking } from "../barbershop/[id]/_actions/cancel-booking";
      ...
      <SheetContent className="px-0">
        ...
        <div className="px-5">
          <div className="relative h-[180px] w-full mt-6">
            <Image src="/barbershop-map.png" className="rounded-2xl" fill alt={booking.barbershop.name} style={{objectFit: "contain"}} />
